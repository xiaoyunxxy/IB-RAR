...
parser.add_argument('--save_IP', default='./mi.npy', type=str, help='info plane save directory')
parser.add_argument('--save_LL', default='./mi_ll.npy', type=str, help='info between layers save directory')
...
# checkpoint_name
checkpoint_name = 'MILoss_'+args.network+'_'+args.dataset+'_'+date_time+'.pth'
...
def train():
    ...
    for epoch in range(args.epoch):
        ...
        for batch_idx, (inputs, targets) in enumerate(tqdm(trainloader)):
            ...
            if batch_idx % 50 == 0 and batch_idx != 0:
                print('[MILoss/Train] Iter: {}, Acc: {:.3f}, Loss: {:.3f}'.format(
                    batch_idx, # Iter
    ...
    # print layers
    print('Selected layers: ', args.selec_layer)
